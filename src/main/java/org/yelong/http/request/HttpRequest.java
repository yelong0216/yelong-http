...
public interface HttpRequest {
	...
	/**
	 * 添加请求头 循环调用{@link #addHeader(String, String)} 其value为null也不会进行添加
	 * 
	 * @param headers
	...
	/**
	 * 获取所有的头信息 这不包含（"Content-Type"）参数，这些参数以独立出来
	 * 
	 * @return 所有的头信息
	 */
	...
	/**
	 * 设置内容 调用此方法设置内容将改变POST请求参数的位置（原放置消息体中，由于设置了消息体则拼接在url上面）
