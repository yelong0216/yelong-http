...
public final class WebUtils {
	...
	/**
	 * 建造查询参数 格式：key1=value1&key2=value2%key3=value3
	 * 
	 * @param paramMap 参数映射
	 * @param charset  编码
	 * @return 查询参数 key1=value1&key2=value2%key3=value3
	 * @throws UnsupportedEncodingException 不支持的编码
	 */
	public static String buildQueryParam(Map<String, String> paramMap, String charset)
	 ...
	 */
	public static byte[] getResponseContent(HttpURLConnection conn) throws IOException {
...
//		InputStream inputStream = conn.getInputStream();
	 ...
	 * @throws IOException
	 */
	public static byte[] buildFileContent(Map<String, String> params, Map<String, FileItem> fileItems, String charset,
	...
	public static File getResponseFile(HttpResponse httpResponse, String filePath) throws HttpException, IOException {
		...
		if (contentDisposition.indexOf("fileName") != -1) {
			...
			fileName = contentDisposition.substring(index,
					contentDisposition.indexOf(";", index) == -1 ? contentDisposition.length()
							: contentDisposition.indexOf(";", index) - 1);
